...
const Upload = () => {
  return (
    <section className="min-h-[calc(100vh-105px)] flex flex-col items-center">
      ...
      <div className="bg-[url('bg_pc.jpg')] h-[calc(100vh-157px)] w-[calc(100%-20px)] mt-4 px-5 rounded-3xl shadow-[0px_-2px_12px_1px_rgba(2,69,149,0.25)] flex flex-col items-center">
        <UploadProfile />
