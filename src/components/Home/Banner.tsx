    ...
    <Swiper>
      <section className=" h-[400px] w-full mt-3 ">
        <div className="w-full h-[90%] overflow-hidden flex flex-col ">
          <div
            className={` w-auto h-full flex space-x-3 items-center relative right-[86.5%] `}
          >
        ...
        <div className="h-[20px] flex space-x-2 items-center justify-center mt-2">
          {[1, 2].map((v) => (
            <label
              key={v + Math.random()}
              className="w-[12px] h-[12px]  rounded-full bg-[#d9d9d9] cursor-pointer flex items-center justify-center "
            >
              <input
                type="radio"
                name="slideTabmenu"
